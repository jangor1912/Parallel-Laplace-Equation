...
if rank == 0:
	...
	with open(csv_file_name, 'a') as csvfile:
		fieldnames = ["time","procesor_no","problem_size_per_proc","problem_size","iterations"]
		writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
		writer.writerow({"time" : time, "procesor_no" : processors,"problem_size_per_proc" :width_per_proc ,"problem_size" : width_per_proc*processors, "iterations":iter_per_proc})
